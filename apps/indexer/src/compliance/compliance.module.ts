 ...
 *
 * TODO(Part 10): the three ports, ScreeningCheck entity (immutable, with list_version +
 *   list_sha256 so a past decision is replayable against the list as it was), velocity limits.
 * TODO(Part 4): blacklist_status projection from indexed Blacklisted/UnBlacklisted events.
 */
