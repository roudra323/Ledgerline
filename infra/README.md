...
| `postgres`          | 5433      | The ledger, both logs and their projections (host port `POSTGRES_PORT`, default 5433 → 5432 in the container) |
| `indexer`           | 3001      | Indexing engine + read API + `/metrics`                                                                       |
| `web`               | 3000      | Demo UI                                                                                                       |
| `mock-psp`          | 4001      | Fake payment provider with a fault-injection API                                                              |
| `loadgen`           | —         | Drives the API with payments, refunds and payouts (`demo` profile)                                            |
