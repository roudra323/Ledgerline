...
| Gate                                                                    | Result                                                                                                                                          |
| ----------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| `pnpm lint` (eslint + `docs:check`, 6 assertions)                       | clean                                                                                                                                           |
| `pnpm format:check`                                                     | clean                                                                                                                                           |
| `pnpm typecheck`                                                        | clean                                                                                                                                           |
| `pnpm test`                                                             | 61 unit + 27 script                                                                                                                             |
| `pnpm test:integration` against a freshly created and migrated database | 74 passed (local `postgresql@17`)                                                                                                               |
